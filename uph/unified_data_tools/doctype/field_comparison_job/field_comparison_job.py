...
class FieldComparisonJob(Document):
    ...
    if TYPE_CHECKING:
        ...
        from uph.unified_data_tools.doctype.field_comparison_job_link.field_comparison_job_link import (
            FieldComparisonJobLink,
        )
        ...
        run_mode: DF.Literal[
            "Manual", "Daily", "Weekly", "Monthly", "Real-Time Triggered"
        ]
        started_at: DF.Datetime | None
        status: DF.Literal["Pending", "Queued", "Running", "Completed", "Failed"]
        title: DF.Data | None
        trigger_on_event: DF.Literal[
            "",
            "Before Insert",
            "Before Save",
            "Validate",
