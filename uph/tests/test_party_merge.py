...
class TestPartyMergeService(FrappeTestCase):
	...
	def _create_party_master(self, name_suffix: str, party_type: str = "Customer") -> str:
	...
	def _create_customer(
		self, name_suffix: str, party_master: str | None = None, currency: str = "USD"
	) -> str:
	...
	def test_case_b_preserves_transactions(self):
		...
		self._create_customer("A4", pm_a, "USD")
		self._create_customer("B4", pm_b, "EUR")
	...
	def test_merge_transfers_pm_accounts(self):
		...
		if account:
			pm_b_doc.append("accounts", {"company": self.test_company, "account": account})
