...
class TestAPIEndpoints(FrappeTestCase):
    def test_get_totals_number_unlinked_parties(self):
        from uph.party.doctype.party_master.party_master import get_totals_number_unlinked_parties
        result = get_totals_number_unlinked_parties()
        self.assertIsInstance(result, dict)

    def test_get_party_master_balances(self):
        from uph.party.doctype.party_master.party_master import get_party_master_balances
    ...
    def test_get_party_master_details_with_parties(self):
        from uph.controllers.party import get_party_master_details_with_parties
