...
def get_party_type_summary(filters=None):
	...
	overall_summary = {
		...
		"total": total_overall,
		"linked_percentage": round((total_linked / total_overall * 100) if total_overall else 0, 2),
		"unlinked_percentage": round((total_unlinked / total_overall * 100) if total_overall else 0, 2),
	}
