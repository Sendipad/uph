...
frappe.query_reports["Party Master Ledger"] = {
	filters: [
		{
	...
	onload: function (report) {
		...
		frappe.ui.keys.add_shortcut({
			...
			action: () => {
				get_print_settings(
					true,
					(print_settings) => frappe.query_report.pdf_report(print_settings),
					letter_heads[0]
				);
			},
		});
...
erpnext.utils.add_dimensions("Party Master Ledger", 16);
