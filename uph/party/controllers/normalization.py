...
class NormalizationUtils:
	...
	@classmethod
	def get_similarity_score(cls, text1: str, text2: str, method: str = "rapidfuzz") -> float:
		"""
	...
	@classmethod
	def fuzzy_extract(cls, query: str, choices: list, scorer: str = "ratio", limit: int = 10) -> list:
		"""
